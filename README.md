...
| `startingPdsaTier`                         | Filters exact match on startingPdsaTiers                                                                                                                                                                                                                            | startingPdsaTier=1,2                                                 |
...
| `ongoing`                                  | Exact match on the ongoing field. Do not use if you don't want to specify ongoing=true or ongoing=false                                                                                                                                                             | ongoing=true                                                         |
